...
import static net.macdidi5.at.voicecommander.R.drawable.ic_eye_center;
import static net.macdidi5.at.voicecommander.R.drawable.ic_eye_close;
import static net.macdidi5.at.voicecommander.R.drawable.ic_eye_left;
import static net.macdidi5.at.voicecommander.R.drawable.ic_eye_right;
...
public class Screen {
    ...
    public Screen(Context context, String i2cBus) throws IOException {
        ...
        bitmaps[2] = BitmapFactory.decodeResource(res, ic_eye_close);
        bitmaps[2] = BitmapFactory.decodeResource(res, ic_eye_center);
    ...
    public void showAction(Context context, int resource) {
    ...
    public void showActionDelay(final Bitmap bitmap, final long delay) {
        actionCount++;
